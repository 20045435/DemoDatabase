...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        // CREATE TABLE task (id_INTEGER PRIMARY KEY AUTOINCREMENT,
        // description TEXT,
        // date TEXT)
    ...
    public void insertTask(String description, String date) {
        ...
        // We use ContentValues object to store the vales for the db operation
    ...
    public ArrayList<String> getTaskContent() {
        ...
        if (cursor.moveToFirst()) {
            // Loop while moveToNext() points to new row
            // and returns true; moveToNext() returns false
            // when no more next row to move to
            do {
                // Add the task content to the ArrayList object
                // getString(0) retrieves the first column data
    ...
    public ArrayList<Task> getTasks(boolean asc) {
        ...
        // SELECT _id, description, date FROM task
